...
def process():
    label_id['text'] = 912032324
    label_name['text'] = "Rohith M"
    label_dob['text'] = "Jan 1 2023"
    label_pin['text'] = "560061"
    label_address['text'] = "Banaglore"
    label_vehicle_type['text'] = "Car"


# Create a button
button1 = Button(root, text="Start", command=process)
